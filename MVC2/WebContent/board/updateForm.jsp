...
<script language="JavaScript" src="script.h.js"></script>
</head>
<body bgcolor="${bodyback_c }">
	<center>
		<b>글수정</b> <br>
		<form method="post" name="writeForm"
			action="/MVC2/board/updatePro.do?pageNum=${pageNum }"
			...
			<table width="400" border="1" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td align="left" width="330"><textarea name="content"
							rows="13" cols="40">${article.content }
						</textarea></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan=2 bgcolor="${value_c }" align="center">
						...
						<input type="reset" value="다시작정">
						<input type="button" value="목록보기" onclick="document.location.href='/MVC2/board/list.do?pageNum=${pageNum}'">
					</td>
					</tr>
			</table>
		</form>
