...
<script type="text/javascript">
	...
	function sendAddress(zipcode, sido, gugun, dong, ri, bunji) {
		var address = sido + " " gugun + " " + dong + " " + fi + " " +bunji;
		...
		<c:if test="${check eq 'n' }">
			...
			<c:if test="${!zipcodeList.isEmpty() }">
				...
				*검색 후, 아래 우편번호를 클릭하면 자동으로 입력됩니다</td>
				...
				<tr>
					<td align="left">
				<a href="javascript:sendAddress('${vo.getZipcode() }','${vo.Sido() }',''${vo.getGugun() }','${vo.getDong() }','${vo.getRi() }','${vo.getBunji() }')">
					${vo.getZipcode() }&nbsp ${vo.Sido() }&nbsp ${vo.getGugun() }&nbsp ${vo.getDong }&nbsp ${vo.getBunji() }
				</a><br /></td>
				</tr>
				</c:forEach>
			</c:if>
