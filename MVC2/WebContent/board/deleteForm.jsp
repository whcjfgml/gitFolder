...
<body bgcolor="${bodyback_c }">
	<center>
		<b>글삭제</b> <br>
		<form method="post" name="deleForm"
			action="/MVC2/board/deletePro.do?pageNum=${pageNum }"
			...
			<table border="1" align="center" cellspacing="0" cellpadding="0"
				...
				<tr height="30">
					<td align="center" bgcolor="${value_c }"><input type="submit"
						...
						onclick="document.loaction.href='/MVC2/board/list.do?pageNum=${pageNum}'">
					</td>
				</tr>
			</table>
		</form>
